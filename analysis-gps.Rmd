...
using age + gender stratification to control potential confounding effects [@canida2017openebgm]:
...
In the top-ranked vaccine-adverse event pairs, we find some commonly reported "adverse reactions" that are can be mostly attributed to human errors or logistical issues, such as:
...
This indicates a possibility to future improve the administer process for or improving the product labeling for certain types of vaccines.
